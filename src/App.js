...
export default function App() {
  ...
  let [certificateImage, setCertificateImage] = useState(undefined);
  let isMessageSent = useSelector(selectViewContact);
  return (
    <div class="container">
      <header>
        <h2
            ...
            <div className="animate__animated animate__backInLeft">
              <div id="about__layout">
                <div>
                  ...
                  <p>
                    As a software developer I am often presented with tasks
                    where I employ solutions. Troubleshooting issues however, is
                    not restricted to technology and should be emplored in the
                    community to improve the standards of all its members. As a
                    problem solver it is my duty to improve my communities to
                    the best of my current abilities.
                  </p>
                  <p>
                    En tant que développeur de logiciels, on me présente souvent
                    des tâches où j’emploie des solutions. Toutefois, les
                    problèmes de dépannage ne se limitent pas à la technologie
                    et devraient être emporés dans la communauté pour améliorer
                    les normes de tous ses membres. En tant que solutionneur de
                    problèmes, il est de mon devoir d’améliorer mes communautés
              ...
              <div id="contact__layout">
                <div>
                  <p>
                    ...
                    veniam. Est ullamco duis Lorem ad duis cillum aute fugiat
                    Lorem. Nisi cupidatat ex aliqua laborum. Eiusmod aute
                    adipisicing dolore eiusmod cillum amet eu qui.
                  </p>
                  <p>
                    Nulla est qui id consectetur id aute voluptate sunt ut
                    fugiat minim esse ut cillum. Fugiat tempor consectetur enim
                    ullamco veniam id excepteur ullamco labore velit dolor duis
                    ex aute. Elit eu quis amet ad ex irure dolore excepteur. Ex
                    duis dolor pariatur cillum ut eiusmod nisi.
                  </p>
                </div>
                <div>
                  <Contact />
                  <div>{isMessageSent && <h2>Your message was sent!</h2>}</div>
                </div>
              </div>
            </div>
          )}
              ...
              <div className="portfolio__lists__layout">
                <div>
                  ...
                  <div id="portfolio__layout">
                    <div>
                      <p>
                        Irure ullamco aute aliquip id veniam sunt ipsum est
                        nulla. Occaecat laboris est duis dolor. Ut mollit dolor
                        dolor labore eiusmod Lorem incididunt ipsum consectetur
                        enim officia non. Voluptate ullamco non nostrud et et
                        nisi id. Sint sint fugiat mollit magna fugiat sit veniam
                        exercitation eu ex amet esse. Quis ex sint magna tempor
                        pariatur velit tempor commodo reprehenderit consectetur
                        quis.
                      </p>
                      <p>
                        Aute velit labore aliqua ex ea do magna reprehenderit
                        pariatur. Occaecat velit Lorem labore sit cupidatat sint
                        do aute labore cupidatat excepteur elit non. Est
                        deserunt nostrud excepteur deserunt eu dolor ex minim
                        commodo irure duis ullamco.
                      </p>
                    </div>
                    <div>
                      <List
